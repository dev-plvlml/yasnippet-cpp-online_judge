...
TEST(GreatestCommonDivisorByDivision, HandlesZero) {
...
TEST(GreatestCommonDivisorByDivision, HandlesOne) {
  EXPECT_EQ(1, GCD_ByDiv(1, 1));
  EXPECT_EQ(1, GCD_ByDiv(1, 42));
  EXPECT_EQ(1, GCD_ByDiv(42, 1));
}

TEST(GreatestCommonDivisorByDivision, HandlesEqual) {
  EXPECT_EQ(42, GCD_ByDiv(42, 42));
}

TEST(GreatestCommonDivisorByDivision, HandlesPrime) {
...
TEST(GreatestCommonDivisorByDivision, HandlesCoprime) {
  EXPECT_EQ(1, GCD_ByDiv(42, 55));
  EXPECT_EQ(1, GCD_ByDiv(55, 42));
}

TEST(GreatestCommonDivisorByDivision, HandlesFibonacci) {
...
TEST(GreatestCommonDivisorByDivision, HandlesArbitrary) {
...
TEST(GreatestCommonDivisorByDivision, HandlesNegative) {
  EXPECT_EQ(1, GCD_ByDiv(-2, -3));
  EXPECT_EQ(1, GCD_ByDiv(-3, -2));
  EXPECT_EQ(7, GCD_ByDiv(-42, -35));
  EXPECT_EQ(7, GCD_ByDiv(-35, -42));
